;( function( $ ) {
	...
	var blogshammirDependencies = {
		...
		init: function() {
			...
			wp.customize.control.each( function( control ) {
				self.showBlogshammirControl( control );
			});
					...
					wp.customize( master, function( setting ) {
						var setupControl = function( control ) {
							...
							isDisplayed = function() {
								return self.showBlogshammirControl( wp.customize.control( slave ) );
							};
		 ...
		 * @returns {bool}
		 */
		showBlogshammirControl: function( control ) {
			var self     = this,
				show     = true,
				i;
		 ...
		 *
		 * @since 1.0.0
		 * @param {Object} requirement - The requirement, inherited from showBlogshammirControl.
	...
	}; // END var blogshammirDependencies

	$( document ).ready( function() {
		blogshammirDependencies.init();
	});
