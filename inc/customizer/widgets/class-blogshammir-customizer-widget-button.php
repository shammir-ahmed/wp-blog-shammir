...
if ( ! class_exists( 'Blogshammir_Customizer_Widget_Button' ) ) :

	/**
	 * Blogshammir Customizer widget class
	 */
	class Blogshammir_Customizer_Widget_Button extends Blogshammir_Customizer_Widget {
		...
		public function __construct( $args = array() ) {
			...
			$args['values']['text']       = wp_kses( $args['values']['text'], blogshammir_get_allowed_html_tags() );
			...
			$this->name        = __( 'Button', 'blogshammir' );
			$this->description = __( 'A button with custom link.', 'blogshammir' );
		...
		public function form() {
			...
			<!-- Text -->
			<p>
				<label for="widget-button-<?php echo esc_attr( $this->id ); ?>-<?php echo esc_attr( $this->number ); ?>-text"><?php esc_html_e( 'Text', 'blogshammir' ); ?>:</label>
				<input 
					type="text" 
					...
					placeholder="<?php esc_attr_e( 'Button Text', 'blogshammir' ); ?>"/>
			</p>

			<!-- URL -->
			<p>
				<label for="widget-button-<?php echo esc_attr( $this->id ); ?>-<?php echo esc_attr( $this->number ); ?>-url"><?php esc_html_e( 'URL', 'blogshammir' ); ?>:</label>
				<input 
					type="text" 
					...
					placeholder="<?php esc_attr_e( 'Button URL', 'blogshammir' ); ?>" />
			</p>

			<!-- Target -->
			<p>
				<label for="widget-button-<?php echo esc_attr( $this->id ); ?>-<?php echo esc_attr( $this->number ); ?>-target"><?php esc_html_e( 'Open link in', 'blogshammir' ); ?>:</label>
			...
			<!-- Class -->
			<p>
				<label for="widget-button-<?php echo esc_attr( $this->id ); ?>-<?php echo esc_attr( $this->number ); ?>-class"><?php esc_html_e( 'Additional class', 'blogshammir' ); ?>:</label>
				<input 
					type="text" 
