...
if ( ! class_exists( 'Blogshammir_Customizer_Widget_Socials' ) ) :

	/**
	 * Blogshammir Customizer widget class
	 */
	class Blogshammir_Customizer_Widget_Socials extends Blogshammir_Customizer_Widget_Nav {
		...
		public function __construct( $args = array() ) {
			...
			$this->name        = __( 'Social Links', 'blogshammir' );
			$this->description = __( 'Links to your social media profiles.', 'blogshammir' );
		...
		public function form() {
			...
			if ( ! empty( $this->styles ) ) { ?>
				<p class="blogshammir-widget-socials-style">
