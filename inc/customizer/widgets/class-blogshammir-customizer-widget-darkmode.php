...
if ( ! class_exists( 'Blogshammir_Customizer_Widget_Darkmode' ) ) :

	/**
	 * Blogshammir Customizer widget class
	 */
	class Blogshammir_Customizer_Widget_Darkmode extends Blogshammir_Customizer_Widget {
		...
		public function __construct( $args = array() ) {
			...
			$this->name        = __( 'Dark mode', 'blogshammir' );
			$this->description = __( 'A dark mode for your site.', 'blogshammir' );
		...
		public function form() {
			...
			if ( ! empty( $this->styles ) ) { ?>
				<p class="blogshammir-widget-darkmode-style">
