...
if ( ! class_exists( 'Blogshammir_Customizer_Widget_Search' ) ) :

	/**
	 * Blogshammir Customizer widget class
	 */
	class Blogshammir_Customizer_Widget_Search extends Blogshammir_Customizer_Widget {
		...
		public function __construct( $args = array() ) {
			...
			$this->name        = __( 'Search', 'blogshammir' );
			$this->description = __( 'A search form for your site.', 'blogshammir' );
		...
		public function form() {
			...
			if ( ! empty( $this->styles ) ) { ?>
				<p class="blogshammir-widget-search-style">
