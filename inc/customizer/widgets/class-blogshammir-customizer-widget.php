...
if ( ! class_exists( 'Blogshammir_Customizer_Widget' ) ) :

	/**
	 * Blogshammir Customizer widget class
	 */
	class Blogshammir_Customizer_Widget {
		...
		public function __construct( $args = array() ) {
			...
			$this->option_name = 'blogshammir_customizer_widget_' . $this->id_base;
		...
		public function template() {
			?>
			<div class="widget" id="blogshammir_widget-<?php echo esc_attr( $this->id_base ); ?>-<?php echo esc_attr( $this->number ); ?>" data-widget-base="<?php echo esc_attr( $this->id_base ); ?>" data-widget-type="<?php echo esc_attr( $this->type ); ?>">

				<div class="widget-top">		

					<div class="widget-title-action">
						<button type="button" class="widget-action" aria-expanded="false">
							<span class="screen-reader-text"><?php esc_html_e( 'Edit widget:', 'blogshammir' ); ?> <?php echo esc_html( $this->name ); ?></span>
					...
					<div class="form">
						<div class="widget-content">
							...
							<?php if ( isset( $this->locations ) && is_array( $this->locations ) && ! empty( $this->locations ) ) { ?>
								...
								<p>
									<label for="blogshammir-widget-location"><?php esc_html_e( 'Widget Location', 'blogshammir' ); ?></label>
							...
							<?php if ( isset( $this->visibility ) && is_array( $this->visibility ) && ! empty( $this->visibility ) ) { ?>
								...
								<p>
									<label for="blogshammir-widget-visibility"><?php esc_html_e( 'Visibility', 'blogshammir' ); ?></label>
						...
						<div class="widget-control-actions">
							<div class="alignleft">
								<button type="button" class="button-link button-link-delete widget-control-remove"><?php esc_html_e( 'Delete', 'blogshammir' ); ?></button>
								<span class="widget-control-close-wrapper">
									|
									<button type="button" class="button-link widget-control-close"><?php esc_html_e( 'Done', 'blogshammir' ); ?></button>
								</span>
							</div>
