<?php
/**
 * Blogshammir Customizer widgets class.
 *
 * @package     Blogshammir
...
if ( ! class_exists( 'Blogshammir_Customizer_Widget_Advertisements' ) ) :

	/**
	 * Blogshammir Customizer widget class
	 */
	class Blogshammir_Customizer_Widget_Advertisements extends Blogshammir_Customizer_Widget {
		...
		public function __construct( $args = array() ) {
			$args['name'] = __( 'Advertisement', 'blogshammir' );
		...
		public function form() {
			...
			<div class="banner-controls" id="bh-banner-<?php echo esc_attr( $this->id ); ?>-<?php echo esc_attr( $this->number ); ?>">
				...
				<div class="banner-wrapper">
					<p>
						...
						<button class="button button-primary widget-media-upload <?php echo $this->values['image_id'] == 0 ? 'show' : 'hide'; ?>" data-widget-id="<?php echo esc_attr( $this->id ); ?>" data-widget-number="<?php echo esc_attr( $this->number ); ?>"><?php esc_html_e( 'Upload Banner', 'blogshammir' ); ?></button>
				...
				<!-- URL -->
				<p>
					<label for="widget-ad-<?php echo esc_attr( $this->id ); ?>-<?php echo esc_attr( $this->number ); ?>-url"><?php esc_html_e( 'URL', 'blogshammir' ); ?>:</label>
					<input 
						type="text" 
						...
						placeholder="<?php esc_attr_e( 'Banner URL', 'blogshammir' ); ?>" />
				</p>

				<!-- Target -->
				<p>
					<label for="widget-ad-<?php echo esc_attr( $this->id ); ?>-<?php echo esc_attr( $this->number ); ?>-target"><?php esc_html_e( 'Open link in', 'blogshammir' ); ?>:</label>
					<span class="buttonset">
						<input 
							...
							<label 
								...
								<?php esc_html_e( 'Same Tab', 'blogshammir' ); ?>
							</label>
						</input>
						<input 
							class="switch-input screen-reader-text" 
							...
							<label 
								...
								<?php esc_html_e( 'New Tab', 'blogshammir' ); ?>
							</label>
						</input>
					</span>
				</p>
			...
			<div id="bh-ad-<?php echo esc_attr( $this->id ); ?>-<?php echo esc_attr( $this->number ); ?>" class="blogshammir-checkbox-group-control blogshammir-ad-display-area">
				<div class="blogshammir-control-heading customize-control-title blogshammir-field">
					<span><?php esc_html_e( 'Show on:', 'blogshammir' ); ?> </span>			
				</div>
				<?php
				foreach ( $this->display_areas as $key => $value ) {
					...
					?>
					<p>
						<label class="blogshammir-checkbox">
							...
							<span class="blogshammir-label"><?php echo esc_html( $value ); ?></span>
						</label>
					</p>
				<?php } ?>
