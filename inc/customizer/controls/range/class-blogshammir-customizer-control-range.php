...
if ( ! class_exists( 'Blogshammir_Customizer_Control_Range' ) ) :
	/**
	 * Blogshammir Customizer custom heading control class.
	 */
	class Blogshammir_Customizer_Control_Range extends Blogshammir_Customizer_Control {
		...
		public function enqueue() {
			parent::enqueue();
			$base_font_size = blogshammir()->options->get( 'blogshammir_html_base_font_size' );
			$bfs            = ( $base_font_size['desktop'] * 16 ) / 100;
			wp_localize_script(
				'blogshammir-range-js',
				'range_obj',
				array(
					'base_font' => $bfs,
				)
		...
		protected function content_template() {
			?>
			<div class="blogshammir-range-wrapper blogshammir-control-wrapper">
				...
				<div class="blogshammir-control-wrap" data-unit="{{ data.value['unit'] }}">
