 ...
 */
class Blogshammir_Customizer_Control_Gallery extends Blogshammir_Customizer_Control {
	 ...
	 * @var string
	 */
	public $type = 'blogshammir-gallery';
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$this->button_labels = wp_parse_args(
			$this->button_labels,
			array(
				'select'       => __( 'Select Images', 'blogshammir' ),
				'change'       => __( 'Modify Gallery', 'blogshammir' ),
				'default'      => __( 'Default', 'blogshammir' ),
				'remove'       => __( 'Remove', 'blogshammir' ),
				'placeholder'  => __( 'No images selected', 'blogshammir' ),
				'frame_title'  => __( 'Select Gallery Images', 'blogshammir' ),
				'frame_button' => __( 'Choose Images', 'blogshammir' ),
			)
		);
	}
