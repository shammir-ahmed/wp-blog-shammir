;( function( $ ) {
	...
	wp.customize.controlConstructor['blogshammir-background'] = wp.customize.Control.extend({
		...
		ready: function() {
			...
			control.container.find( 'input[type=range]' ).on( 'mousedown', function() {
				...
				range 			= $( this );
				range_input 	= range.parent().children( '.blogshammir-range-input' );
				...
				range.mousemove( function() {
					...
					clearTimeout( blogshammir_range_input_number_timeout );

					blogshammir_range_input_number_timeout = setTimeout( function() {
