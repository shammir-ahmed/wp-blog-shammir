...
if ( ! class_exists( 'Blogshammir_Customizer_Control_Sortable' ) ) :
	/**
	 * Blogshammir Customizer custom select control class.
	 */
	class Blogshammir_Customizer_Control_Sortable extends Blogshammir_Customizer_Control {
		 ...
		 * @var string
		 */
		public $type = 'blogshammir-sortable';
		...
		protected function content_template() {
			?>
				<div class="blogshammir-control-wrapper blogshammir-sortable-wrapper">
					...
					<ul class="blogshammir-sortable-control">
						<# for ( key in data.value ) { #>
							<li class="blogshammir-sortable-item<# if ( _.has( data.value, key) && ! data.value[ key ] || ! _.has( data.value, key ) && _.has( data.default, key ) && ! data.default[ key ] ) { #> invisible<# } #>" data-value="{{ key }}">
								<# if ( data.sortable ) { #>
