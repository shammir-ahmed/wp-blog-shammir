<?php
/**
 * Blogshammir Customizer Widget control class.
 *
 * @package     Blogshammir
...
if ( ! class_exists( 'Blogshammir_Customizer_Control_Widget' ) ) :
	/**
	 * Blogshammir Customizer custom select control class.
	 */
	class Blogshammir_Customizer_Control_Widget extends Blogshammir_Customizer_Control {
		 ...
		 * @var string
		 */
		public $type = 'blogshammir-widget';
		...
		public function to_json() {
			...
			if ( is_array( $this->widgets ) && ! empty( $this->widgets ) ) {
				...
				foreach ( $this->widgets as $widget_id => $args ) {
					...
					ob_start();
					?>
					<div data-widget-id="<?php echo esc_attr( $instance->id_base ); ?>" class="blogshammir-widget-tpl-<?php echo esc_attr( $instance->id_base ); ?> blogshammir-widget" data-max-uses=<?php echo esc_attr( $max_uses ); ?>>
		...
		protected function content_template() {
			?>
			<div class="blogshammir-control-wrapper blogshammir-widget-wrapper">

				<div class="blogshammir-widget-container">

					<# _.each( data.value, function( template, i ) { #>
						{{{ template }}}
					<# }); #>

				</div><!-- END .blogshammir-widget-container -->

				<div class="blogshammir-add-widget-wrap">			
					<button type="button" class="button blogshammir-add-widget" data-location-title="{{{ data.label }}}" data-control="{{{ data.id }}}"><?php esc_html_e( 'Add Widget', 'blogshammir' ); ?></button>
				</div>

				<div class="blogshammir-widget-tmpls">
