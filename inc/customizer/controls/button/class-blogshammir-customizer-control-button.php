...
if ( ! class_exists( 'Blogshammir_Customizer_Control_Button' ) ) :
	/**
	 * Blogshammir Customizer custom background control class.
	 */
	class Blogshammir_Customizer_Control_Button extends Blogshammir_Customizer_Control {
		 ...
		 * @var string
		 */
		public $type = 'blogshammir-button';
		...
		protected function content_template() {
			?>
			<div class="blogshammir-button-wrapper blogshammir-control-wrapper">
			...
			<# if ( data.description ) { #>
				<div class="description customize-control-description blogshammir-field">{{{ data.description }}}</div>
			<# } #>
