<?php
/**
 * Blogshammir Customizer custom textarea control class.
 *
 * @package     Blogshammir
...
if ( ! class_exists( 'Blogshammir_Customizer_Control_Textarea' ) ) :
	/**
	 * Blogshammir Customizer custom select control class.
	 */
	class Blogshammir_Customizer_Control_Textarea extends Blogshammir_Customizer_Control {
		 ...
		 * @var string
		 */
		public $type = 'blogshammir-textarea';
		...
		protected function content_template() {
			?>
			<div class="blogshammir-control-wrapper blogshammir-textarea-wrapper">
