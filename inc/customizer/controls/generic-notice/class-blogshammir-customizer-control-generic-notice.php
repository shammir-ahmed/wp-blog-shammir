 ...
 * @access public
 */
class Blogshammir_Customizer_Control_Generic_Notice extends WP_Customize_Section {
	 ...
	 * @var    string
	 */
	public $type = 'blogshammir-generic-notice';
	...
	/**
	 * Blogshammir_Hiding_Section constructor.
	 *
	...
	public function enqueue() {
		 Blogshammir_Customizer_Plugin_Install_Helper::instance()->enqueue_scripts();
	}
	...
	protected function render_template() {
		...
		<li id="accordion-section-{{ data.id }}"
				class="blogshammir-notice accordion-section control-section control-section-{{ data.type }} cannot-expand">
	...
	public function create_plugin_install_button( $slug, $settings = array() ) {
		return Blogshammir_Customizer_Plugin_Install_Helper::instance()->get_button_html( $slug, $settings );
	}
}
