<?php
/**
 * Blogshammir Customizer custom spacing control class.
 *
 * @package     Blogshammir
...
if ( ! class_exists( 'Blogshammir_Customizer_Control_Spacing' ) ) :
	/**
	 * Blogshammir Customizer custom select control class.
	 */
	class Blogshammir_Customizer_Control_Spacing extends Blogshammir_Customizer_Control {
		 ...
		 * @var string
		 */
		public $type = 'blogshammir-spacing';
		...
		public function to_json() {
			...
			$this->json['title']   = esc_html__( 'Link values', 'blogshammir' );
		...
		protected function content_template() {
			?>
			<div class="blogshammir-control-wrapper blogshammir-spacing-wrapper<# if ( data.responsive ) { #> blogshammir-control-responsive <# } #>">
				...
				<# if ( ! _.isEmpty( data.unit ) ) { #>
					<div class="blogshammir-control-unit">
				...
				</div><!-- END .blogshammir-control-wrap -->
