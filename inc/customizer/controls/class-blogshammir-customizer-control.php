...
if ( ! class_exists( 'Blogshammir_Customizer_Control' ) ) :
	/**
	 * Blogshammir Customizer custom control class. To be extended in other controls.
	 */
	class Blogshammir_Customizer_Control extends WP_Customize_Control {
		...
		public function __construct( $manager, $id, $args = array() ) {
			...
			if ( isset( $args['responsive'] ) && true === $args['responsive'] ) {
				$this->responsive = apply_filters(
					'blogshammir_customizer_responsive_breakpoints',
					array(
						'desktop' => array(
		...
		protected function responsive_devices() {
			?>
			<ul class="blogshammir-responsive-switchers">
		...
		public static function template_units() {
			?>
			<script type="text/template" id="tmpl-blogshammir-control-unit">
