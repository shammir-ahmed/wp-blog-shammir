...
if ( ! class_exists( 'Blogshammir_Customizer_Control_Alignment' ) ) :
	/**
	 * Blogshammir Customizer custom background control class.
	 */
	class Blogshammir_Customizer_Control_Alignment extends Blogshammir_Customizer_Control {
		 ...
		 * @var string
		 */
		public $type = 'blogshammir-alignment';
		...
		public function __construct( $manager, $id, $args = array() ) {
			...
			$this->strings = wp_parse_args(
				...
				array(
					'top-left'     => __( 'Top Left', 'blogshammir' ),
					'top'          => __( 'Top', 'blogshammir' ),
					'top-right'    => __( 'Top Right', 'blogshammir' ),
					'left'         => __( 'Left', 'blogshammir' ),
					'center'       => __( 'Center', 'blogshammir' ),
					'right'        => __( 'Right', 'blogshammir' ),
					'bottom-left'  => __( 'Bottom Left', 'blogshammir' ),
					'bottom'       => __( 'Bottom', 'blogshammir' ),
					'bottom-right' => __( 'Bottom Right', 'blogshammir' ),
				)
			);
		...
		protected function content_template() {
			?>
			<div class="blogshammir-alignment-wrapper blogshammir-control-wrapper">
				...
				<div class="blogshammir-alignment-control">

					<# if ( ! data.choices['top-left'] && ! data.choices['top'] && ! data.choices['top-right'] ) { #>
						<div class="button-group blogshammir-top">
							<label class="blogshammir-left {{{ data.choices['top-left']}}}">
							...
							<label class="blogshammir-center {{{ data.choices['top']}}}">
							...
							<label class="blogshammir-right {{{ data.choices['top-right']}}}">
					...
					<# if ( ! data.choices['left'] && ! data.choices['center'] && ! data.choices['right'] ) { #>
						<div class="button-group blogshammir-middle">
							<label class="blogshammir-left {{{ data.choices['left']}}}">
							...
							<label class="blogshammir-center {{{ data.choices['center']}}}">
							...
							<label class="blogshammir-right {{{ data.choices['right']}}}">
					...
					<# if ( ! data.choices['bottom-left'] && ! data.choices['bottom'] && ! data.choices['bottom-right'] ) { #>							
						<div class="button-group blogshammir-bottom">
							<label class="blogshammir-left {{{ data.choices['bottom-left']}}}">
							...
							<label class="blogshammir-center {{{ data.choices['bottom']}}}">
							...
							<label class="blogshammir-right {{{ data.choices['bottom-right']}}}">
