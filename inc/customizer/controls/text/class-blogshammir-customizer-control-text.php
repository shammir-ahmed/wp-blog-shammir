...
if ( ! class_exists( 'Blogshammir_Customizer_Control_Text' ) ) :
	/**
	 * Blogshammir Customizer custom select control class.
	 */
	class Blogshammir_Customizer_Control_Text extends Blogshammir_Customizer_Control {
