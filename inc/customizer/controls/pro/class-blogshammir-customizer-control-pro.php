	...
	class Blogshammir_Customizer_Control_Pro extends Blogshammir_Customizer_Control {
		...
		public function content_template() {?>
			...
			<div style="padding: 1rem;background: #e6e6e6;">
				<img class="blogshammir_img_responsive " src="{{{ data.screenshot }}}" alt="<?php esc_attr_e( 'BlogShammir Pro', 'blogshammir' ); ?>">
			</div>  
			<# }  #>       
			<div class="">
				<h3 style="margin-top:10px;padding: 10px;color:#111;font-size:16px;margin-bottom: 0;background: #fff;border-bottom: 1px solid #ddd;border-top: 3px solid #2271b1;"><?php esc_html_e( 'BlogShammir Pro Features', 'blogshammir' ); ?></h3>
				<ul style="padding: 10px;background: #fff;">
					<# _.each(data.features, function(feature){ #>
						<li class="upsell-blogshammir"> <div class="dashicons dashicons-yes"></div> {{{ feature }}} </li>
					<# }); #>
				</ul>
			</div>
			...
			<p style="padding: 10px;background: #fff; margin-top: 0;">
				<?php
					printf( __( 'If you Like our Products , Please Rate us 5 star on %1$sWordPress.org%2$s.  We\'d really appreciate it! </br></br>  Thank You', 'blogshammir' ), '<a target="_blank" href="https://wordpress.org/support/view/theme-reviews/blogshammir?filter=5">', '</a>' );
				?>
			</p>
			<?php
		}
