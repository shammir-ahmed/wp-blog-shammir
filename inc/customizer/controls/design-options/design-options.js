;(function($) {
 	...
 	wp.customize.controlConstructor['blogshammir-design-options'] = wp.customize.Control.extend({
		...
		ready: function() {
			...
			// Range controls.
			control.container.find( '.blogshammir-range-wrapper' ).each( function() {
				var $this = $(this);
			...
			control.container.find( 'input.blogshammir-range-input' ).on( 'change keyup', function() {
			...
			control.container.on( 'change', '.blogshammir-select-wrapper', function(){
				control.update_value();
			});
			...
			// Linked button
			control.container.on( 'click', '.blogshammir-spacing-linked', function() {
			...
			// Unlinked button
			control.container.on( 'click', '.blogshammir-spacing-unlinked', function() {
