<?php
/**
 * Blogshammir Customizer design options control class.
 *
 * @package BlogShammir
...
if ( ! class_exists( 'Blogshammir_Customizer_Control_Design_Options' ) ) :
	/**
	 * Blogshammir Customizer design options control class.
	 */
	class Blogshammir_Customizer_Control_Design_Options extends Blogshammir_Customizer_Control {
		 ...
		 * @var string
		 */
		public $type = 'blogshammir-design-options';
		...
		public function to_json() {
			...
			$this->json['l10n'] = array(
				'background-type' => esc_html__( 'Type', 'blogshammir' ),
				'gradient'        => array(
					'color-1'         => esc_html__( 'Color 1', 'blogshammir' ),
					'color-2'         => esc_html__( 'Color 2', 'blogshammir' ),
					'color-location'  => esc_html__( 'Location', 'blogshammir' ),
					'type'            => esc_html__( 'Type', 'blogshammir' ),
					'linear'          => esc_html__( 'Linear', 'blogshammir' ),
					'radial'          => esc_html__( 'Radial', 'blogshammir' ),
					'angle'           => esc_html__( 'Angle', 'blogshammir' ),
					'position'        => esc_html__( 'Position', 'blogshammir' ),
						...
						<# if ( 'color' in data.display['background'] ) { #>
							...
							<div data-dep-field="background-type" data-dep-value="color">
								...
								<div class="popup-element color-element style-1">
									...
									<input class="blogshammir-color-control" data-option="background-color" type="text" value="{{data.value['background-color']}}" data-show-opacity="true" data-default-color="{{data.default['background-color']}}" />
								</div>
							</div>
						<# } #>
						...
						<# if ( 'gradient' in data.display['background'] ) { #>
							...
							<div data-dep-field="background-type" data-dep-value="gradient">
								...
								<div class="popup-element color-element style-1">
									...
									<input class="blogshammir-color-control" data-option="gradient-color-1" type="text" value="{{data.value['gradient-color-1']}}" data-show-opacity="true" data-default-color="{{data.default['gradient-color-1']}}" />
								</div>
								...
								<div class="popup-element color-element style-1">
									...
									<input class="blogshammir-color-control" data-option="gradient-color-2" type="text" value="{{data.value['gradient-color-2']}}" data-show-opacity="true" data-default-color="{{data.default['gradient-color-2']}}" />
								</div>
							...
							<div class="blogshammir-background-wrapper" data-dep-field="background-type" data-dep-value="image">
								...
								<div class="background-image-advanced">
									...
									<div class="background-color-overlay popup-element color-element style-1">
										...
										<label for="background-color-overlay-{{ data.id }}"><h4><?php esc_html_e( 'Overlay Color', 'blogshammir' ); ?></h4></label>

										<input class="blogshammir-color-control" data-option="background-color-overlay" type="text" value="{{data.value['background-color-overlay']}}" data-show-opacity="true" data-default-color="{{data.default['background-color-overlay']}}" />
									</div>
					...
					<# if ( 'color' in data.display ) { #>
						...
						<# _.each( data.display['color'], function( title, id ){ #>
							...
							<div class="popup-element color-element style-1">
								...
								<input class="blogshammir-color-control" data-option="{{ id }}" type="text" value="{{data.value[ id ]}}" data-show-opacity="true" data-default-color="{{data.default[ id ]}}" />
							</div>
						<# }); #>
					...
					<# if ( 'border' in data.display ) { #>
									...
									<ul class="active">
										...
										<li class="spacing-control-wrap">
											<div class="spacing-link-values">
												<span class="dashicons dashicons-admin-links blogshammir-spacing-linked" data-element="{{ data.id }}" title="{{ data.title }}"></span>
												<span class="dashicons dashicons-editor-unlink blogshammir-spacing-unlinked" data-element="{{ data.id }}" title="{{ data.title }}"></span>
											</div>
										</li>
						...
						<# if ( 'color' in data.display['border'] ) { #>
							...
							<div class="popup-element color-element style-1">
								...
								<input class="blogshammir-color-control" data-option="border-color" type="text" value="{{data.value['border-color']}}" data-show-opacity="true" data-default-color="{{data.default['border-color']}}" />
							</div>
						<# } #>
						...
						<# if ( 'separator' in data.display['border'] ) { #>
							...
							<div class="popup-element color-element style-1">
								...
								<input class="blogshammir-color-control" data-option="separator-color" type="text" value="{{data.value['separator-color']}}" data-show-opacity="true" data-default-color="{{data.default['separator-color']}}" />
							</div>
						<# } #>
