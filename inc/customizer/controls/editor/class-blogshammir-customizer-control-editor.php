...
/**
 * Blogshammir Customizer editor control class.
 */
class Blogshammir_Customizer_Control_Editor extends Blogshammir_Customizer_Control {
	/**
	 ...
	 * @var    string
	 */
	public $type = 'blogshammir-editor';
	...
	protected function content_template() {
		?>
		<div class="blogshammir-control-wrapper wp-js-editor blogshammir-textarea-wrapper">
			<label>
				<# if ( data.label ) { #>
