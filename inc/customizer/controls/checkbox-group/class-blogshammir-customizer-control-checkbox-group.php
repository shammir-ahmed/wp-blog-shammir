...
if ( ! class_exists( 'Blogshammir_Customizer_Control_Checkbox_Group' ) ) :
	/**
	 * Blogshammir Customizer checkbox group control class.
	 */
	class Blogshammir_Customizer_Control_Checkbox_Group extends Blogshammir_Customizer_Control {
		 ...
		 * @var string
		 */
		public $type = 'blogshammir-checkbox-group';
		...
		protected function content_template() {
			?>
			<div class="blogshammir-checkbox-group-wrapper blogshammir-control-wrapper">
				...
				<div class="blogshammir-checkbox-group-control">
					...
					<# _.each( data.choices, function( params, key ) { #>
						...
						<p>
							<label class="blogshammir-checkbox">
								...
								<span class="blogshammir-label">{{ params.title }}
									<# if ( params.desc ) { #>
									<i class="blogshammir-info-icon">
										<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-help-circle">
											<circle cx="12" cy="12" r="10"></circle>
										...
										<span class="blogshammir-tooltip">{{ params.desc }}</span>
									</i>
									<# } #>
								</span>
							</label>
			...
			</div><!-- END .blogshammir-button-wrapper -->
			<?php
		}
