<?php
/**
 * Blogshammir Customizer custom text control class.
 *
 * @package     Blogshammir
...
if ( ! class_exists( 'Blogshammir_Customizer_Control_Datetime' ) ) :
	/**
	 * Blogshammir Customizer custom select control class.
	 */
	class Blogshammir_Customizer_Control_Datetime extends Blogshammir_Customizer_Control {
		 ...
		 * @var string
		 */
		public $type = 'blogshammir-datetime';
		...
		protected function content_template() {
			?>
			<div class="blogshammir-control-wrapper blogshammir-text-wrapper">
				...
				<label>
					...
					<div class="blogshammir-info-text">{{{ data.info }}}</div>
				</label>
