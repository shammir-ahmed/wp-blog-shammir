...
if ( ! class_exists( 'Blogshammir_SocialSnap' ) ) :
	/**
	 * Social Snap compatibility class.
	 */
	class Blogshammir_SocialSnap {
		...
		public function __construct() {
			...
			add_filter( 'blogshammir_default_option_values', array( $this, 'default_customizer_values' ), 20 );

			// Remove Social Snap Lite from recommended plugins.
			add_filter( 'blogshammir_recommended_plugins', array( $this, 'update_recommended_plugins' ) );

			// Include helper functions.
			require BLOGSHAMMIR_THEME_PATH . '/inc/compatibility/socialsnap/socialsnap-functions.php'; // phpcs:ignore
		}
		...
		public function register_options( $options ) {
			...
			$options['setting']['blogshammir_single_post_meta_elements']['control']['choices']['shares'] = esc_html__( 'Shares', 'blogshammir' );

			$options['setting']['blogshammir_blog_entry_meta_elements']['control']['choices']['shares'] = esc_html__( 'Shares', 'blogshammir' );
		...
		public function default_customizer_values( $defaults ) {
			...
			$defaults['blogshammir_single_post_meta_elements']['shares'] = false;
			$defaults['blogshammir_blog_entry_meta_elements']['shares']  = false;
