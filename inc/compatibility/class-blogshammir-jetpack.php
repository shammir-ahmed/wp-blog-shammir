...
if ( ! class_exists( 'Blogshammir_Jetpack' ) ) :
	/**
	 * Jetpack compatibility class.
	 */
	class Blogshammir_Jetpack {
		...
		public function tweak_credits_link() {
			return '<a href="https://wordpress.org/" rel="noopener noreferrer" target="_blank">' . esc_html__( 'Proudly powered by WordPress', 'blogshammir' ) . '</a> | <a href="https://github.com/shammir-ahmed" rel="noopener noreferrer" target="_blank">Md Shammir Ahmed</a>';
		}
		...
		public function filter_infinite_scroll_js_settings( $settings ) {
			...
			$settings['text'] = esc_html__( 'Load More', 'blogshammir' );
