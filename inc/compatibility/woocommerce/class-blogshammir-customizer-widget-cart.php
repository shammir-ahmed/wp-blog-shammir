...
if ( ! class_exists( 'Blogshammir_Customizer_Widget_Cart' ) ) :

	/**
	 * Blogshammir Customizer widget class
	 */
	class Blogshammir_Customizer_Widget_Cart extends Blogshammir_Customizer_Widget {
		...
		public function __construct( $args = array() ) {
			...
			$this->name        = esc_html__( 'Cart', 'blogshammir' );
			$this->description = esc_html__( 'Displays WooCommerce cart.', 'blogshammir' );
		...
		public function form() {
			...
			if ( ! empty( $this->styles ) ) {
				...
				?>
				<p class="blogshammir-widget-cart-style">
