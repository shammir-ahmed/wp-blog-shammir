...
if ( ! class_exists( 'Blogshammir_Meta_Boxes' ) ) :

	/**
	 * Meta Boxes Class.
	 */
	class Blogshammir_Meta_Boxes {
		...
		public function metabox_config() {
			...
			// Sidebar position.
			$layout_settings['blogshammir_sidebar_position'] = array(
				'id'      => 'blogshammir_sidebar_position',
				'name'    => esc_html__( 'Sidebar', 'blogshammir' ),
				'type'    => 'select',
				'default' => 'default',
				'choices' => array(
					''              => esc_html__( 'Default (from Customizer)', 'blogshammir' ),
			...
			// Content layout.
			$layout_settings['blogshammir_content_layout'] = array(
				'id'      => 'blogshammir_content_layout',
				'name'    => esc_html__( 'Content Layout', 'blogshammir' ),
				'type'    => 'select',
				'default' => 'default',
				'choices' => array(
					''             => esc_html__( 'Default (from Customizer)', 'blogshammir' ),
			...
			$layout_settings['blogshammir_page_sections'] = array(
				'id'     => 'blogshammir_page_sections',
				'type'   => 'group',
				'fields' => array(),
			);

			// Disable Top Bar.
			if ( blogshammir_option( 'top_bar_enable' ) ) {
				$layout_settings['blogshammir_page_sections']['fields']['blogshammir_disable_topbar'] = array(
					'id'      => 'blogshammir_disable_topbar',
					'name'    => esc_html__( 'Disable Top Bar', 'blogshammir' ),
					'default' => false,
					'type'    => 'checkbox',
				);
			}
			...
			// Disable Header.
			$layout_settings['blogshammir_page_sections']['fields']['blogshammir_disable_header'] = array(
				'id'      => 'blogshammir_disable_header',
				'name'    => esc_html__( 'Disable Main Header', 'blogshammir' ),
				'default' => false,
				'type'    => 'checkbox',
			);
			...
			if ( blogshammir_option( 'page_header_enable' ) ) {
				$layout_settings['blogshammir_page_sections']['fields']['blogshammir_disable_page_title'] = array(
					'id'      => 'blogshammir_disable_page_title',
					'name'    => esc_html__( 'Disable Page Title', 'blogshammir' ),
					'default' => false,
					'type'    => 'checkbox',
				);
			}
			...
			if ( blogshammir_option( 'page_header_enable' ) && blogshammir_option( 'breadcrumbs_enable' ) && ! blogshammir_is_section_disabled( blogshammir_option( 'breadcrumbs_hide_on' ), get_the_ID() ) ) {
				$layout_settings['blogshammir_page_sections']['fields']['blogshammir_disable_breadcrumbs'] = array(
					'id'      => 'blogshammir_disable_breadcrumbs',
					'name'    => esc_html__( 'Disable Breadcrumbs', 'blogshammir' ),
					'default' => false,
					'type'    => 'checkbox',
				);
			}
			...
			$layout_settings['blogshammir_page_sections']['fields']['blogshammir_disable_thumbnail'] = array(
				'id'      => 'blogshammir_disable_thumbnail',
				'name'    => esc_html__( 'Disable Featured Image', 'blogshammir' ),
				'default' => false,
				'type'    => 'checkbox',
			);
			...
			if ( blogshammir_option( 'enable_footer' ) ) {
				$layout_settings['blogshammir_page_sections']['fields']['blogshammir_disable_footer'] = array(
					'id'      => 'blogshammir_disable_footer',
					'name'    => esc_html__( 'Disable Main Footer', 'blogshammir' ),
					'default' => false,
					'type'    => 'checkbox',
				);
			}
			...
			if ( blogshammir_option( 'enable_copyright' ) ) {
				$layout_settings['blogshammir_page_sections']['fields']['blogshammir_disable_copyright'] = array(
					'id'      => 'blogshammir_disable_copyright',
					'name'    => esc_html__( 'Disable Copyright Bar', 'blogshammir' ),
					'default' => false,
					'type'    => 'checkbox',
				);
			}
			...
			// Set metabox options.
			$this->metabox = array(
				'blogshammir-theme-page-options' => array(
					'id'         => 'blogshammir-theme-page-options',
					'post_type'  => $this->get_post_types(),
					'capability' => 'edit_posts',
					'label'      => esc_html__( 'Theme Page Options', 'blogshammir' ),
					'context'    => 'side',
					'priority'   => 'core',
			...
			$this->metabox = apply_filters( 'blogshammir_metabox_options', $this->metabox );
		}
		...
		public function render( $post, $metabox ) {
			...
			foreach ( $metabox['args']['settings'] as $setting ) {
				...
				echo '<div class="blogshammir-meta-box-field">';
		...
		public function render_field_checkbox( $post, $setting ) {
			...
			?>
			<div class="components-panel__row blogshammir-checkbox-row">
				<div class="components-base-control">
					<div class="components-base-control__field">
						<span class="components-checkbox-control__input-container blogshammir-checkbox-wrapper">
							...
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" role="img" class="blogshammir-checked-icon components-checkbox-control__checked" aria-hidden="true" focusable="false"><path d="M9 18.6L3.5 13l1-1L9 16.4l9.5-9.9 1 1z"></path></svg>
						</span>
		...
		public function load_assets( $hook ) {
			...
			if ( 'post-new.php' === $hook || 'post.php' === $hook ) {
				...
				if ( in_array( $post_type, $post_types, true ) ) {
					...
					wp_enqueue_style(
						'blogshammir-metabox-style',
						BLOGSHAMMIR_THEME_URI . '/inc/admin/assets/css/blogshammir-meta-boxes' . $blogshammir_suffix . '.css',
						false,
...
/**
 * The function which returns the one Blogshammir Meta Boxes instance.
 *
 ...
 * @return object
 */
function blogshammir_meta_boxes() {
	return Blogshammir_Meta_Boxes::get_instance();
}

blogshammir_meta_boxes();
