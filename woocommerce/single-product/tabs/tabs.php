 ...
 *
 * Blogshammir changes: added blogshammir-container wrappers and blogshammir-fw-section. Added span inside tabs a elements,
 * because of underline animation. Added .blogshammir-entry to woocommerce-Tabs-panel (only if key === 'description' ).
 *
...
if ( ! empty( $product_tabs ) ) : ?>
	...
	<div class="woocommerce-tabs blogshammir-fw-section wc-tabs-wrapper">
		...
		foreach ( $product_tabs as $key => $product_tab ) :
			$blogshammir_classes = 'description' === $key ? 'blogshammir-entry ' : '';

			$blogshammir_classes .= sprintf( 'woocommerce-Tabs-panel woocommerce-Tabs-panel--%s', esc_attr( $key ) );
			?>
